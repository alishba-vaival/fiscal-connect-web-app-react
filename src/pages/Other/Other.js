      ...
      <div className="page-content">
        <Container fluid>
          <Row>
            ...
            >
              <Form>
                <BreadCrumb title="Other" pageTitle="OtherPage" />
                <Row>
                  <Col
                    md={3}
                    style={{
                  ...
                  >
                    <FormGroup>
                      <Label for="financialYearOther">Financial Year</Label>
                      <select
                ...
                <Row>
                  <Col md={3}>
                    <FormGroup>
                      <Label for="siteNameOther">Site Name</Label>
                      <select
                        className="form-select form-select-md"
                        aria-label=".form-select-md example"
                        required
                ...
                <Row>
                  <Col md={3}>
                    <FormGroup>
                      <Label for="remarksOther">Remarks</Label>
                      <Input
                        id="remarks *"
                        name="remarks *"
