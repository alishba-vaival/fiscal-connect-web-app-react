...
import ParticlesAuth from "./ParticlesAuth.js";
...
const BasicSignIn = () => {
    ...
    document.title = "Login | CRM Vaival Solutions";
    return (
        <React.Fragment>
            <ParticlesAuth>
                                            ...
                                            <form action="#">
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <div className="position-relative auth-pass-inputgroup mb-3">
                                                        ...
                                                        <button className="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="password-addon" onClick={() => (showPassword ? setShowassword(false) : setShowassword(true))}><i className="ri-eye-fill align-middle"></i></button>
                                                    </div>
                                                </div>
