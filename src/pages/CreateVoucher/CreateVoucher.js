         ...
         <div className="page-content">
            ...
            <Container fluid>
              <Row>
                ...
                >
                  <Form>
                  <BreadCrumb title="CreateVoucher" pageTitle="CreateVoucherPage" />
                    <Row>
                      <Col md={3} 
                      style={{
                        marginLeft: "55rem",
                        ...
                        <FormGroup>
                          <Label for="financialYearCreateVoucher">Financial Year</Label>
                          <select
                    ...
                    <Row>
                      <Col md={3}>
                        <FormGroup>
                          <Label for="siteNameCreateVoucher">Site Name</Label>
                          <select
                            className="form-select form-select-md"
                            aria-label=".form-select-md example"
                            required
                      ...
                      <Col md={3}>
                        <FormGroup>
                          <Label for="dateCreateVoucher">Date</Label>
                          <Flatpickr
                      ...
                      <Col md={3}>
                        <FormGroup>
                          <Label for="amountCreateVoucher">Amount</Label>
                          <Input
                            id="amount"
                            name="amount"
                    ...
                    <Row>
                      <Col md={5}>
                        <FormGroup>
                          <Label for="taxAccountCreateVoucher">Tax Account</Label>
                          <select
                            className="form-select form-select-md"
                            aria-label=".form-select-md example"
                            required
                      ...
                      <Col md={3}>
                        <FormGroup>
                          <Label for="taxAmountCreateVoucher">Tax Amount</Label>
                          <Input
                            id="taxAmount"
                            name="taxAmount"
                      ...
                      <Col md={3}>
                        <FormGroup>
                          <Label for="netAmountCreateVoucher">Net Amount</Label>
                          <Input
                            id="netAmount"
                            name="netAmount"
                    ...
                    <Row>
                      <Col md={5}>
                        <FormGroup>
                          <Label for="remarksCreateVoucher">Remarks</Label>
                          <Input
                            id="remarks *"
                            name="remarks *"
                      ...
                      <Col md={3}>
                        <FormGroup>
                          <Label for="chequeCreateVoucher">Cheque No</Label>
                          <Input
                            id="cheque"
                            name="cheque"
